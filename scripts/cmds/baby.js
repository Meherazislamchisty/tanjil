...
module.exports.onChat = async ({
    ...
    try {
        ...
        if (body.startsWith("baby") || body.startsWith("bby") || body.startsWith("bot") || body.startsWith("jan") || body.startsWith("babu") || body.startsWith("janu")) {
            ...
            const rawReplies = [
  "How Can I help you 😒🌷","আমাকে না ডেকে আমার boss Chisty কে ডাক 🐿️💨","আমি জামাই এর সাথে ব্যস্ত আছি 🙈👀🌊","hea Jan bolo 🎀","এখন আমার মন ভালো না পরে কথা বলি 💗☺️","তুমি নাকি আমার boss Chisty এর বউ 🙈😥"
];
